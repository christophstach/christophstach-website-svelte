<script lang="ts">
	import type { HTMLAnchorAttributes, AriaAttributes } from 'svelte/elements';

	type SocialLinkProps = HTMLAnchorAttributes & AriaAttributes;

	let { target, children, ...restProps }: SocialLinkProps = $props();
</script>
